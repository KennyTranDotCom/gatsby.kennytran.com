...
const NavSocial = (props) => {
    const copyToClipboard = (event) => {
        ...
        try {
            ...
            toast(inputEmail.value + ' has been copied to your clipboard');
        } finally {
        ...
        <nav className="c-nav-social">
            <ul>
                <li>
                    <a
                        aria-label="Github"
                        href="https://github.com/KennyTranDotCom"
                    >
                        <svg
                            width="28"
                            height="23"
                ...
                <li>
                    <a
                        aria-label="LinkedIn"
                        href="https://www.linkedin.com/in/kennytrandotcom/"
                    >
                        <svg
                            width="25"
                            height="25"
                ...
                <li>
                    <a
                        aria-label="Twitter"
                        href="https://twitter.com/KennyTranDotCom"
                    >
                        <svg
                            width="29"
                            height="24"
                ...
                <li>
                    <button aria-label="Email" onClick={copyToClipboard}>
                        <svg
                            width="29"
                            height="23"
                            xmlns="http://www.w3.org/2000/svg"
